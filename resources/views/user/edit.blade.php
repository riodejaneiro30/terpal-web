...
<div class="min-h-screen flex items-center justify-center">
    <div class="flex w-full">
        ...
        <div class="flex-1 py-8 px-8">
            ...
            <form action="{{ route('user.update', $user->id) }}" method="POST" class="bg-white shadow-md rounded-lg p-6">
                @csrf
                @method('PUT')
                <div class="mb-4">
                ...
                <div class="mb-4">
                    <label for="password" class="block text-sm font-medium text-gray-700">{{ __('Password (Kosongkan jika tidak ingin mengubah)') }}</label>
